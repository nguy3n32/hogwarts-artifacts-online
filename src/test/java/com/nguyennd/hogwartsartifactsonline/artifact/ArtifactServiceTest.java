...
class ArtifactServiceTest {
    ...
    // When test Mockito will inject the Mock into the class need to test
    // It will not be real Repository
    @Mock
    ...
    void testFindByIdSuccess() {
        // Given. Arrange inputs and targets. Define the behavior of Mock Object Repository
        /*
        ...
        // verify the method is call 1 times
    ...
    void testFindAllSuccess() {
        ...
        // Then
        assertThat(actualArtifacts).hasSameSizeAs(this.artifacts);
