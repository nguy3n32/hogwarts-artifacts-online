...
class ArtifactControllerTest {
    ...
    void testFindArtifactByIdNotFound() throws Exception {
        ...
        given(this.artifactService.findById("1250808601744904191"))
                .willThrow(new ObjectNotFoundException(Artifact.class.getSimpleName(),"1250808601744904191"));
    ...
    void testAddArtifactSuccess() throws Exception {
        ...
        ArtifactDto artifactDto = new ArtifactDto(
                null,
                "Remembral",
                "Remembral Description",
                "ImageUrl",
                null
        );
        // mockMVC can not send DTO Object in post request, so we need to convert DTO Object to JSON
        // Use ObjectMapper to solve this problem
        ...
        savedartifact.setDescription("Remembrall Description");
    ...
    void testUpdateArtifactSuccess() throws Exception {
        ...
        // When and Then
        this.mockMvc.perform(put(this.baseUrl + "/artifacts/1250808601744904197")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(json)
                        .accept(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.flag").value(true))
    ...
    void testUpdateArtifactNotFound() throws Exception {
        ...
        given(this.artifactService.update(eq("1250808601744904197"),Mockito.any(Artifact.class)))
                .willThrow(new ObjectNotFoundException(Artifact.class.getSimpleName(),"1250808601744904197"));
    ...
    void testDeleteArtifactErrorWithNonExistentId() throws Exception {
        // Given
        doThrow(new ObjectNotFoundException(Artifact.class.getSimpleName(),"1250808601744904191"))
